      ...
      <div className="w-[80%] mx-auto items-center grid grid-cols-1 lg:grid-cols-2 gap-[2rem]">
        <div>
          ...
          <p className="text-gray-900 opacity-90 text-[17px] mt-[1rem]">
            ...
            deleniti possimus, totam nihil similique ut consequuntur,
            repudiandae quo magnam praesentium incidunt illo error soluta
            nesciunt.
          </p>
          <div className="flex items-center space-x-6 mt-[2rem]">
            ...
            <div>
              ...
              <p className="md:w-[70%] w-[90%] text-[15px] text-black opacity-85 space-x-0">
