      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 items-center w-[80%] mx-auto">
        <div className="col-span-2">
          ...
          <p
            data-aos="fade-left"
            data-aos-delay="200"
            className="md:text-[17px] text-[15px] mb-[2rem] text-black opacit-90 font-[400]"
          >
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi
            quibusdam cupiditate enim perferendis distinctio totam corrupti
            itaque aut, inventore commodi quam.
          </p>
          <div
            data-aos="zoom-in"
            data-aos-delay="400"
